...
urlpatterns = [
    ...
    # 리뷰 작성, 수정, 삭제
    path('create/<str:mood_pk>/<str:movie_pk>/', views.create, name='create'),
    path('read/<str:mood_pk>/<str:movie_pk>/', views.read, name='read'),
    # path('update/<str:mood_pk>/<str:movie_pk>/', views.update, name='update'),
